...
| app/agent/conversations | Canonical JSON validation/transitions, summaries, context views, and non-destructive legacy import | Model execution, document RAG, or project catalog membership | ConversationRepository, ConversationMigrator, LegacyChromaReader | app/agent/conversations | Confirmed |
